...
`data-proyectos.rdata` se crea a partir de la Base Integrada con un script integrado en `consultas.qmd`. Esta es una base *wide* que tiene como unidad de análisis los proyectos de investigación. 
